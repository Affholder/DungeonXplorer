...
class HeroController {
    ...
    public function create() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $heroName = $_POST['hero_name'] ?? 'Aventurier sans nom';
            ...
            try {
                // Mapping des images par classe
                $classImages = [
                    'Guerrier' => '/DungeonXplorer/public/images/Berserker.jpg',
                    'Mage'     => '/DungeonXplorer/public/images/Wizard.jpg',
                    'Voleur'   => '/DungeonXplorer/public/images/Thief.jpg'
                ];
                ...
                if ($classStats) {
                    // Déterminer l'image selon le nom de la classe
                    $heroImage = $classImages[$classStats['name']] ?? 'public/images/default.jpg';

                    // Insérer le héros avec l'image
                    $sql = "INSERT INTO Hero (name, class_id, pv, pv_max, mana, mana_max, strength, initiative, xp, user_id, image) 
                            VALUES (:name, :cid, :pv, :pv, :mana, :mana, :str, :init, 0, :userid, :image)";
